...
ENV_KEYS=(
  ...
  QBT_WEB_UI_USERNAME
  QBT_WEB_UI_PASSWORD
  # Legacy/alternate names without underscore
  QBT_WEBUI_ADDRESS
  QBT_WEBUI_USERNAME
  QBT_WEBUI_PASSWORD
  QBT_SAVE_PATH
...
# Legacy/alternate env names (no underscore) expected by some image versions
QBT_WEBUI_ADDRESS=${QBT_WEBUI_ADDRESS:-${QBT_WEB_UI_ADDRESS:-$QBT_WEB_UI_ADDRESS_DEFAULT}}
QBT_WEBUI_USERNAME=${QBT_WEBUI_USERNAME:-$QBT_WEB_UI_USERNAME}
QBT_WEBUI_PASSWORD=${QBT_WEBUI_PASSWORD:-$QBT_WEB_UI_PASSWORD}
