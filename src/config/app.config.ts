...
export const qbtWebuiAddress = cfg.QBT_WEB_UI_ADDRESS;
export const qbtWebuiUsername = cfg.QBT_WEB_UI_USERNAME;
export const qbtWebuiPassword = cfg.QBT_WEB_UI_PASSWORD;
